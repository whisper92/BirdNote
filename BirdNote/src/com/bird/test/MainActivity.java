...
public class MainActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
	{
        ...
        childNote.byteArrayChildDrawContent=BitmapUtil.bitmapToBytearray(b1);
        childNote.byteArrayChildThumbnail=BitmapUtil.bitmapToBytearray(b2);
        ...
        birdNote.byteArrayNoteContent=BitmapUtil.bitmapToBytearray(b1);
        birdNote.byteArrayNoteThumbnail=BitmapUtil.bitmapToBytearray(b2);
