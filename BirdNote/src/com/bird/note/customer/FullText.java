...
/**
 * A EditTextview full of screen in the EditQuadrantFragment
 *
 * @author wangxianpeng
 * @since 19/12/14
 */
public class FullText extends EditText {
	...
	private void init(Context context) {
		...
		myHandler.postDelayed(mTextWatchRunnable, 500);

	}

	private Runnable mTextWatchRunnable = new Runnable() {
		@Override
		public void run() {
			addTextChangedListener(mFullTextWatcher);

		}
	};

	private TextWatcher mFullTextWatcher = new TextWatcher() {
		@Override
