...
public class SavedPaint {
	public static int[] mColorImages = new int[] { R.id.id_color_00,
			R.id.id_color_01, R.id.id_color_02, R.id.id_color_03,
			R.id.id_color_04, R.id.id_color_05, R.id.id_color_06,
			R.id.id_color_07, R.id.id_color_08, R.id.id_color_09,
			R.id.id_color_10, R.id.id_color_11, R.id.id_color_12,
			R.id.id_color_13, R.id.id_color_14, R.id.id_color_15 };
	public static int[] mColors = new int[] { 0xff16cc79, 0xff01932e,
			0xff04672e, 0xffff82c9, 0xffff365b, 0xffff0000, 0xffff6000,
			0xffa5a5a5, 0xff727272, 0xff363636, 0xff38a8fe, 0xff3467fe,
			0xff005aff, 0xfffcff0c, 0xffffffff, 0xff000000 };

	public static int[] mProgressDrawable = new int[] {
			R.drawable.seekbar_drawable00, R.drawable.seekbar_drawable01,
			R.drawable.seekbar_drawable02, R.drawable.seekbar_drawable03,
			R.drawable.seekbar_drawable04, R.drawable.seekbar_drawable05,
			R.drawable.seekbar_drawable06, R.drawable.seekbar_drawable07,
			R.drawable.seekbar_drawable08, R.drawable.seekbar_drawable09,
			R.drawable.seekbar_drawable10, R.drawable.seekbar_drawable11,
			R.drawable.seekbar_drawable12, R.drawable.seekbar_drawable13,
			R.drawable.seekbar_drawable14, R.drawable.seekbar_drawable15 };
